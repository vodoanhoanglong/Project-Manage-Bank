...
public class PanelService extends JPanel
{
    ...
    public PanelService()
    {
        ...
        panelMessage.setLayout(new FlowLayout(FlowLayout.CENTER,0,30));
        panelMessage.setBackground(Color.WHITE);
        panelMessage.setPreferredSize(new Dimension(500,60));
        ...
        JPanel panelCancel = new RoundedPanel(20);
        panelCancel.setBackground(new Color(86, 109, 184));
        panelCancel.add(new JLabel("Cancel"));
        panelCancel.setOpaque(false);
        panelCancel.addMouseListener(new PanelButtonMouseAdapter.PBService(panelCancel, 86, 109, 184)
        {
            @Override
        ...
        JPanel panelConfirm = new RoundedPanel(20);
        panelConfirm.setBackground(new Color(55, 119, 34));
        panelConfirm.add(new JLabel("Confirm"));
        panelConfirm.setOpaque(false);
        panelConfirm.addMouseListener(new PanelButtonMouseAdapter.PBService(panelConfirm,55, 119, 34)
        {
            @Override
            public void mouseClicked(MouseEvent e)
            {
